...
function convertSticker(base64, author, pack) {
	return new Promise((resolve, reject) => {
	  axios.post('https://webp-converter.com/api/convert', {
		image: base64,
		stickerMetadata: {
		  author,
		  pack,
...
const banner2 = cfonts.render(('Canal: HTTPS://BOTDEFIGURINHAS.COM.BR'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`NANA-BOT\n5.1`), {
font: 'slick',             
align: 'center',           
